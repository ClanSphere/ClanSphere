...
UPDATE {pre}_options SET options_value = '2010-05-02' WHERE options_mod = 'clansphere' AND options_name = 'version_date';
UPDATE {pre}_options SET options_value = 51 WHERE options_mod = 'clansphere' AND options_name = 'version_id';
