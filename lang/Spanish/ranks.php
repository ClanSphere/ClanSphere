...
$cs_lang['code_info'] = 'Para USar el Código Fuente, deje vacio la Pagina de Web y la URL de la Imagen';
$cs_lang['no_name'] = '- El nombre no puede estar vacio';
$cs_lang['no_url'] = '- Tiene que a&ntilde;adir una Pagina Web';
$cs_lang['no_img'] = '- La URL de la imagen no puede estar vacia';
$cs_lang['rank_exists'] = '- Una Lista con ese Nombre ya existe';
