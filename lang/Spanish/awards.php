...
$cs_lang['new_award'] = 'Nueva Conderacion';
$cs_lang['event'] = 'Espectáculo';
$cs_lang['place'] = 'Colocacción';
$cs_lang['game'] = 'Juego';
$cs_lang['info'] = 'Infos';
$cs_lang['game_create'] = 'Nuevo';
$cs_lang['edit_done'] = 'Editado';
$cs_lang['all'] = 'Por ahora existen %s conderaciones';
$cs_lang['event_url'] = 'Pagina de Web';
$cs_lang['no_date'] = '- Tiene que apuntarse la Fecha';
$cs_lang['no_event'] = '- Tiene que apuntarse un Espectáculo';
