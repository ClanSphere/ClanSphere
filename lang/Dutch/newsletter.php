...
$cs_lang['squad']='Squad';
$cs_lang['empty']='Geen nieuwsbrieven beschikbaar';
$cs_lang['new_manage']='Nieuwe nieuwsbrief';
$cs_lang['ac_group']='Toegangsgroep';
$cs_lang['clan']='Clan';
$cs_lang['require'] = 'Vul alle velden met een * in';
$cs_lang['to'] = 'Aan';
$cs_lang['all2']='Totaal: ';
$cs_lang['new_newsletter']='Nieuwe nieuwsbrief';
$cs_lang['sucessfull']='%s Mails verzonden.';
$cs_lang['next']='Doorgaan';
