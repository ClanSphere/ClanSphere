...
$cs_lang['max_height'] = 'Max foto hoogte: ';
$cs_lang['max_size'] = 'Max foto grootte: ';
$cs_lang['def_func'] = 'Standaard functie';
$cs_lang['pixel'] = 'Pixel';
$cs_lang['bytes'] = 'Bytes';
$cs_lang['img'] = 'Foto';
$cs_lang['str'] = 'Tekst';
$cs_lang['image_height'] = 'Max. Fotohoogte op het Forum en in het gastenboke';
$cs_lang['image_width'] = 'Max. Fotobreedte op het Forum en in het gastenboke';

$cs_lang['pattern'] = 'Patroon';
...
$cs_lang['no_result'] = '- Geen output gegeven';
$cs_lang['no_file'] = '- Geen file geselecteerd';
$cs_lang['up_error'] = '- Onbekende foutmelding, neem contact op met de webbeheerder.';

$cs_lang['cut'] = 'Max. lengte van een woord';
$cs_lang['cut_more'] = 'letters - Toets 0 om het afkappen van lange woorden uit te schakelen';
$cs_lang['def_abcode'] = 'Toon forum code toeten overal';
