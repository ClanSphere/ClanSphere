...
$cs_lang['error_user_noavailable'] = '- Gebruiker niet gevonden!';
$cs_lang['notice'] = 'Aantekening';
$cs_lang['search'] = 'Zoeken';
$cs_lang['status'] = 'Status';
$cs_lang['new_buddy'] = 'Nieuwe vriend toevoegen';

$cs_lang['user'] = 'Gebruiker';
$cs_lang['users'] = 'Gebruikers';
$cs_lang['on'] = 'Online gebruiker';
$cs_lang['off'] = 'Offline gebruiker';
