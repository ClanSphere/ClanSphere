...
$cs_lang['running'] = 'en cours';
$cs_lang['canceled'] = 'annulée';
...
$cs_lang['score'] = 'Résultats';
$cs_lang['url'] = 'Site Web';
$cs_lang['report'] = 'Rapport';
$cs_lang['add_player'] = 'Ajouter un joueur';

$cs_lang['no_game'] = '- Saisissez un jeu';
$cs_lang['no_cat'] = '- Saisissez une catégorie';
$cs_lang['no_enemy'] = '- Saisissez un opponent';
$cs_lang['no_squad'] = '- Saisissez une section';
$cs_lang['no_date'] = '- Saisissez une date';
$cs_lang['no_status'] = '- Saisissez un status';

// Join
$cs_lang['join'] = 'Participer';
$cs_lang['not_upcoming'] = '- La date de cette rencontre n\'est pas proche';
$cs_lang['no_squadmember'] = '- Vous n\'êtes pas membre de cette section';
$cs_lang['join_war'] = 'Voulez vous participer à ce match?';
...
$cs_lang['wins'] = 'Victoires';
$cs_lang['looses'] = 'Défaites';
$cs_lang['draws'] = 'Egalités';
...
// Rounds
$cs_lang['rounds_management'] = 'Administration des matchs.';
$cs_lang['new_round'] = 'Nouvelle manche';
$cs_lang['map'] = 'Carte';
$cs_lang['result'] = 'Résultat';
$cs_lang['short_description'] = 'Description';
$cs_lang['errors'] = 'Les erreurs suivantes se sont produites :';
$cs_lang['no_map'] = 'Carte introuvable';
$cs_lang['edit_round'] = 'Editer un match';
$cs_lang['rounds_edit'] = 'Editer les manches';
$cs_lang['delete_round'] = 'Supprimer une manche';
$cs_lang['really_delete'] = 'Voulez vous vraiment supprimer la manche?';

// Remove
$cs_lang['remove_rly'] = 'Voulez vous supprimer le bloc de données N° %s?';
...
$cs_lang['admin'] = 'Oui (Admin-Inscription)';
