...
$cs_lang['empty_cache'] = 'Supprimer les répertoires du cache';
$cs_lang['reload'] = 'Raffraichir';
$cs_lang['cache_cleared'] = 'Cache vidé';
$cs_lang['size'] = 'Taille';
$cs_lang['wizard'] = 'Assistant';
$cs_lang['task_done'] = 'Marquer la tâche effectuée';

$cs_lang['manual'] = 'manuellement';
$cs_lang['about'] = 'à propos';
$cs_lang['lang'] = 'Langage';
$cs_lang['version'] = 'Version';
$cs_lang['active'] = 'Actif';
$cs_lang['change'] = 'Langage changé avec succès';
$cs_lang['lang_list'] = 'Liste des traductions';
$cs_lang['page_mode'] = 'Mode de page';
...
$cs_lang['def_width'] = 'Largeur de table';
$cs_lang['def_title'] = 'Titre de page';
$cs_lang['def_show'] = 'Page de démarrage';
$cs_lang['def_path'] = 'Racine du serveur';
$cs_lang['def_timezone'] = 'Fuseau horaire';
$cs_lang['def_dstime'] = 'Heure d\'été';
$cs_lang['def_flood'] = 'Antiflood';
$cs_lang['seconds'] = 'Secondes';
$cs_lang['def_org'] = 'Préfixe mail';
$cs_lang['def_mail'] = 'E-Mail standard';
$cs_lang['img_path'] = 'Racine des icônes';
$cs_lang['img_ext'] = 'Format des icônes';
$cs_lang['maintenance'] = 'Maintenance';
$cs_lang['modul'] = 'Module';
$cs_lang['action'] = 'Action';
$cs_lang['parameters'] = 'Paramêtre';


$cs_lang['def_admin'] = 'Administration';
$cs_lang['integrated'] = 'Integré';
...
$cs_lang['webserver'] = 'Serveur WEB';
$cs_lang['zend_eng'] = 'Moteur Zend';
$cs_lang['db_infos'] = 'Informations sur la banque de données';
$cs_lang['type'] = 'Serveur de banque de données';
$cs_lang['client'] = 'Version du client';
$cs_lang['host'] = 'Location de la banque de données';
$cs_lang['server'] = 'Version du serveur';

$cs_lang['usage'] = 'Utilisation';
...
// Lang Validator
$cs_lang['validator'] = 'Validateur';
$cs_lang['line'] = 'Ligne';
$cs_lang['error_type'] = 'Type d\'erreur';
$cs_lang['text'] = 'Texte';
...
$cs_lang['show_fixed'] = 'Afficher les Fichiers non-double';
$cs_lang['save_fixed'] = 'Sauvergarder les fichiers non-double';

// Version
$cs_lang['head_version'] = 'Version';
$cs_lang['body_version'] = 'Rechercher une nouvelle version';
$cs_lang['status'] = 'Status';
$cs_lang['installed'] = 'Installée';
$cs_lang['available'] = 'Disponible';
$cs_lang['up_to_date'] = 'Votre version clansphere est actuelle';
$cs_lang['new_release'] = 'Une nouvelle version est disponible';

$cs_lang['need_url_fopen'] = 'Erreur: L\'option PHP "allow_url_fopen" doit être activée';
$cs_lang['file_not_read'] = 'Erreur: Le fichier à distance d\'examination n\'a pas pu être chargé';
$cs_lang['support'] = 'Support';

// Support

$cs_lang['body_support'] = 'Liste des offres importantes du projet';
$cs_lang['name_board'] = 'Forum';
$cs_lang['text_board'] = 'Questions ou problémes? Les modérateurs et la communauté vous aident.';
$cs_lang['name_bugs'] = 'Erreur';
$cs_lang['text_bugs'] = 'Cela ne fonctionne pas comme prévu? Envoyez nous un compte-rendu.';
$cs_lang['name_contact'] = 'Contact';
$cs_lang['text_contact'] = 'Envoyez directement vos questions à l\'équipe du projet.';
$cs_lang['name_design'] = 'Design de la banque de donnée';
$cs_lang['text_design'] = 'Vous trouverez d\'autres templates ici.';
$cs_lang['name_lang'] = 'Langage de la banque de données';
$cs_lang['text_lang'] = 'Vous trouverez d\'autres langages ici.';
$cs_lang['name_mods'] = 'Module de banque de données';
$cs_lang['text_mods'] = 'Vous trouverez d\'autres langages ici.';
$cs_lang['name_svn'] = 'Version sub';
$cs_lang['text_svn'] = 'Vous pouvez télécharger l\'état actuel du développement pour seulement l\'essayer!';
