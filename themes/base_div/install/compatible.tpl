...
<table class="forum" cellpadding="0" cellspacing="1" style="width:{page:width}" cellpadding="0" cellspacing="0">
 <tr>
  <td class="headb">{lang:check}</td>
  <td class="headb" style="width:25%">{lang:required}</td>
  <td class="headb" style="width:25%">{lang:found}</td>
  <td class="headb" style="width:25%">{lang:enough}</td>
 </tr>
 <tr>
...
<table class="forum" cellpadding="0" cellspacing="1" style="width:100%" cellpadding="0" cellspacing="0">
 <tr>
  <td class="headb">{lang:check}</td>
