<div class="container" style="width:{page:width}">
	<div class="headb">{lang:mod} - {lang:folders_create}</div>
	<div class="leftb">{body:folders} {error:icon} {error:error} {error:message}</div>
</div>
<br />
...
<table class="forum" cellpadding="0" cellspacing="1" style="width:{page:width}">
  ...
  <tr>
    ...
    <td class="leftb"><textarea name="folders_text" cols="50" rows="15" id="folders_text"  style="width: 98%;">{data:folders_text}</textarea> 
		</td>
  </tr>
	<tr>
