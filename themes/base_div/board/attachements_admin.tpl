<div class="container" style="width:{page:width}">
    <div class="headb">{lang:mod} - {lang:attachments}</div>
    <div class="leftb clearfix">
    	<div style="float:left"><a href="{link:back}">{lang:back}</a></div>
        <div style="float:right">{lang:all} {count:all}</div>
    </div>
</div>
<br />
