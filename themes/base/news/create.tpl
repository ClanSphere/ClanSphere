...
<br />
{stop:preview}
<form method="post" name="news_create" action="{url:news_create}">
  <table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
    <tr>
	...
	<tr>
      ...
      <td class="leftb" colspan="2"><div id="editor_readmore" style="display:none">{abcode:features_readmore}
        <textarea name="news_readmore" cols="50" rows="20" id="news_readmore"  style="width: 98%;">{news:news_readmore}</textarea></div></td>
    </tr>
    <tr>
