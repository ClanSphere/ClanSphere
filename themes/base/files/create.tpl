...
<br />
<form method="post" name="files_create" action="{url:files_create}" enctype="multipart/form-data">
  <table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
    <tr>
    ...
    <tr>
      ...
      <td class="leftc">{icon:kedit} {lang:name}
        <input type="text" name="files_mirror_name_{mirrors:num}" value="{mirrors:name}" maxlength="50" size="20" /></td>
    </td>
    </tr>
    <tr>
