<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
  ...
  <tr>
    ...
    <td class="leftc" colspan="2">{games:release}</td>
  </tr>
  <tr>
    <td class="leftb">{icon:folder_yellow} {lang:genre}</td>
    <td class="leftc" colspan="2">{games:genre}</td>
  </tr>
  <tr>
    <td class="leftb">{icon:kedit} {lang:creator}</td>
    <td class="leftc" colspan="3">{games:creator}</td>
  </tr>
  <tr>
    <td class="leftb">{icon:gohome} {lang:homepage}</td>
    <td class="leftc" colspan="3">{games:homepage}</td>
  </tr>
</table>
