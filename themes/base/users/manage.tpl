...
<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
 <tr>
  ...
  <tr>
    ...
    <td class="leftb">
      <input type="text" name="search_name" id="search_name" value="{search:name}" autocomplete="off" onkeyup="Clansphere.ajax.user_autocomplete('search_name','search_users_result')" size="50" maxlength="100" />
