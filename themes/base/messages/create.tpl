...
<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
  <tr>
    ...
    <td class="leftb"><input type="text" name="messages_to" id="messages_to" value="{msg:to}" autocompletion="off" onkeyup="Clansphere.ajax.user_autocomplete('messages_to','search_users_result')" maxlength="200" size="50" /><br />
