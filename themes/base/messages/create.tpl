...
<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
  <tr>
    ...
    <td class="leftb"><input type="text" name="messages_to" id="messages_to" value="{msg:to}" autocomplete="off" onkeyup="Clansphere.ajax.user_autocomplete('messages_to', 'search_users_result' ,'{page:path}')" maxlength="200" size="50" /><br />
  ...
  <tr>
    ...
    <td class="leftb">
      {msg:abcode}
      <textarea class="rte_abcode" name="messages_text" cols="50" id="messages_text">{msg:text}</textarea></td>
  </tr>
  <tr>
