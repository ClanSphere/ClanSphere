...
<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
  ...
  <tr>
    ...
    <td class="centerc"><input type="checkbox" name="select_{msgs_in:messages_id}" value="1" class="form" /></td>
...
<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
  ...
  <tr>
    ...
    <td class="centerc"><input type="checkbox" name="select_{msgs_out:messages_id}" value="1" class="form" /></td>
