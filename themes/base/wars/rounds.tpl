<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
	<tr>
		<td class="headb" colspan="2">{lang:mod} - {lang:rounds}</td>
	</tr>
	<tr>
...
<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
	...
	<tr>
		...
		<td class="leftb">
			{abcode:features}
			<textarea name="rounds_description" cols="20" rows="15" id="rounds_description">{wars:rounds_description}</textarea>
		</td>
	</tr>
	<tr>
