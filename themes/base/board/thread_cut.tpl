<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
 <tr>
   <td class="headb">{lang:mod} - {lang:cut_comment_as_thread}</td>
 </tr>
 <tr>
...
<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}" >
 ...
 <tr>
   ...
   <td class="leftb" colspan="2">{abcode:features}<br /><textarea rows="20" cols="50" name="threads_text" id="threads_text">{comment:comments_text}</textarea></td>
 </tr>
 <tr>
