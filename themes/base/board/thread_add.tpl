<table class="forum" style="width:{page:width}" cellpadding="0" cellspacing="{page:cellspacing}">
	<tr>
		<td class="headb">{lang:mod} - {lang:head}</td>
	</tr>
	<tr>
...
<table class="forum" style="width:{page:width}" cellpadding="0" cellspacing="{page:cellspacing}">
	...
	<tr>
		...
		<td class="leftb">
			{abcode:features}
			<textarea name="threads_text" cols="50" rows="20" id="threads_text" style="width:98%">{data:threads_text}</textarea>
		</td>
	</tr>
	{if:vote}
	<tr>
	...
	<tr>
		...
		<td class="leftb">
			...
			<div style="float:left;padding:3px;border:1px solid black;background:gainsboro;">
				<a href="/mods/gallery/image.php?boardpic={files:name}" target="cs1" ><img src="/mods/gallery/image.php?boardpic={files:name}&boardthumb" alt="" /></a>
			</div>
