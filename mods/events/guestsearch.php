...
$data['guests']['search'] = empty($_POST['guests_search']) ? '' : $_POST['guests_search'];
...
$data['head']['pages'] = cs_pages('events','guestsearch',$data['head']['count'],$start,$guests_search,$sort);

$data['sort']['user'] = cs_sort('events','guestsearch',$start,$guests_search,1,$sort);
$data['sort']['name'] = cs_sort('events','guestsearch',$start,$guests_search,3,$sort);
