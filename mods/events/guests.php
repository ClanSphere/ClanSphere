...
$select = 'egt.eventguests_since AS eventguests_since, egt.users_id AS users_id, usr.users_nick AS users_nick, usr.users_surname AS users_surname, usr.users_active AS users_active, usr.users_name AS users_name, egt.eventguests_id AS eventguests_id';
...
for($run=0; $run<$eventguests_loop; $run++) {
  $data['eventguests'][$run]['user'] = cs_user($cs_eventguests[$run]['users_id'],$cs_eventguests[$run]['users_nick'], $cs_eventguests[$run]['users_active']);
