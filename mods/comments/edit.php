...
// Id: edit.php (Sun Nov 16 15:55:03 CET 2008) fAY-pA!N
...
$cells = 'users_id, comments_text, comments_time, comments_fid, comments_edit, comments_mod';
...
if(!empty($error) OR isset($_POST['preview']) OR !isset($_POST['submit'])) {
  ...
  echo cs_subtemplate(__FILE__,$data,'comments','edit');
	...
	$com_save = array($cs_com['comments_text'],$com_edits);
  cs_sql_update(__FILE__,'comments',$com_cells,$com_save,$com_id);
	
  cs_redirect($cs_lang['changes_done'],'comments');
}
