		...
		if(!empty($server['gq_online'])) {
			...
			if(!empty($cs_servers['servers_stats'])) {
				...
				if(isset($server['map']) && !empty($server['map'])) {
					...
					if(file_exists('uploads/servers/' . $cs_servers['servers_class'] . '/' . $data['servers']['map'] . '.jpg')) {
						$data['servers']['mappic'] = 'uploads/servers/' . $cs_servers['servers_class'] . '/' . $data['servers']['map'] . '.jpg';
					}
					else {
						$data['servers']['mappic'] = 'uploads/servers/' . $cs_servers['servers_class'] . '/default.jpg';
					}
				}
