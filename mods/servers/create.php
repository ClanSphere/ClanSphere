...
if(!empty($servers_error) OR !isset($_POST['submit'])) {
  ...
  $server_array = array(
    ...
    array('name' => 'Age of Empires II', 'servers_class' => 'ase;aoe'),
    ...
    array('name' => 'Day of Defeat: Source', 'servers_class' => 'source;dods'),
    array('name' => 'Deadly Dozen: Pacific Theater', 'servers_class' => 'gamespy;ddpt'),
    array('name' => 'Descent 3', 'servers_class' => 'gamespy;d3'),
    array('name' => 'Deus Ex', 'servers_class' => 'gamespy2;de'),
