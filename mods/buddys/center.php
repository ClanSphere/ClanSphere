...
if(isset($_GET['notice'])) {
  ...
  settype($id,'integer');
	...
	$from = 'buddys bds INNER JOIN {pre}_users usr ON bds.buddys_user = usr.users_id';
	$select = 'bds.buddys_id AS buddys_id, bds.buddys_time AS buddys_time, bds.buddys_user AS ';
	$select .= 'buddys_user, bds.users_id AS users_id, usr.users_nick AS users_nick, usr.users_laston AS ';
  ...
  $buddy_data['buddys']['buddys_user']    = $cs_buddys['buddys_user'];
  $buddy_data['buddys']['users_nick']     = $cs_buddys['users_nick'];
