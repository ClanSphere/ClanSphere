...
$select = 'ntm.notifymods_id, usr.users_id, usr.users_nick, usr.users_active, usr.users_delete, ntm.notifymods_gbook, ntm.notifymods_joinus, ntm.notifymods_fightus';
