...
$cs_user = cs_sql_select(__FILE__,'users','users_nick, users_register, users_active',"users_id = '" . $user_id . "'");
$user = cs_user($user_id,$cs_user['users_nick'],$cs_user['users_active']);
